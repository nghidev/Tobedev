            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('be.product.create') }}" class="btn btn-success" data-toggle="modal"><i
                                    class="material-icons">&#xE147;</i> <span>Them san pham</span></a>
                    ...
                    <tbody >
                        @foreach ($products as $item)
                            <tr>
                                ...
                                <td>{{ $item->id }}</td>
                                <td>
                                    <img src="{{ asset(Storage::url('images/product/' . $item->feature_image)) }}"
                                        style="height: 100px;width:100px;"></img>
                                    {{ $item->name }}
                                    <small>
                                        {{ $item->getCategory()->first()->name??'' }}
                                    </small>
                                </td>
                                <td>{{ $item->code }}</td>
                                ...
                                <td>
                                    <a href="{{ url('be/product/') }}/{{ $item->id }}" class="edit"
                                        data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
                                            title="Edit">&#xE254;</i></a>
                                    <a href="{{ url('be/product/delete/') }}/{{ $item->id }}" class="delete"
                                        data-toggle="modal" ><i class="material-icons" data-toggle="tooltip"
                                            title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
